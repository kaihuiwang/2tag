    ...
    <ul class="<?= implode(' ', $classes) ?>">
        ...
        if (!$clean) {
            ...
            for ($x = 0; $x < $leading; ++$x) {
                ...
                ?>
                <li class="number"><a data-pagenumber="<?= ($current + $x - $leading) ?>"
                                      href="<?= ($href) ?>"><?= ($current + $x - $leading) ?></a></li>
            <?php
            }
            ...
            for ($x = 0; $x < $trailing; ++$x) {
                ...
                ?>
                <li class="number"><a data-pagenumber="<?= ($current + $x + 1) ?>"
                                      href="<?= ($href) ?>"><?= ($current + $x + 1) ?></a></li>
            <?php
            }
        }

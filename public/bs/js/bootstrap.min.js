    ...
    c.VERSION = "3.2.0", c.TRANSITION_DURATION = 150, c.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (j) {
                ...
                h = "bottom" == h && k.top + k.height + m - p.scroll > p.height ? "top" : "top" == h && k.top - p.scroll - m < p.top ? "bottom" : "right" == h && k.right + l > p.width ? "left" : "left" == h && k.left - l < p.left ? "right" : h, f.removeClass(n).addClass(h)
            }

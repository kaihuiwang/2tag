...
<div class="row" style="margin-top: 10px;">
    <div class="col-sm-12 mytab">
        <span class="label label-default">职位添加</span>
    </div>
</div>
    ...
    <div class="col-lg-9">
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?php echo url("/admin/access/add"); ?>" method="post" role="form">
                    <?php echo zl_form::getCsrf(); ?>
                    <div class="form-group">
                        <label for="intName">职位名称</label>
                        <input type="text" class="form-control" id="intName" name="name" data-rule="职位名称: required;name">
                    </div>
                    <div  id="access">
                                ...
                                foreach($nodes as $k=>$v):
                                    ...
                                    <ul>
                                        ...
                                        foreach($v as $v1):
                                            ...
                                            ?>
                                            <li>
                                            <input type="checkbox" name="access[]" value="<?php echo $url_name ?>">&nbsp;&nbsp;&nbsp;&nbsp;
